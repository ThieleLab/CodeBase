...
## Plots the reactions with significantly different abundance between groups for 
## each scenario in microbiome model analysis.
...
for (i in 1:length(scenarios)) {
  infoPath = paste(
    "data/analysis_MicrobiomeModels/Scenarios/",
    scenarios[i],
    "/",
    scenarios[i],
    "_samples.csv",
