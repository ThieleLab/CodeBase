...
datatypes={
    ...
    'reaction_presence','Reaction_presence_'
...
for i=1:length(scenarios)
    for j=1:size(datatypes,1)
        ...
        data = readInputTableForPipeline([rootDir filesep 'data' filesep 'analysis_MicrobiomeModels' filesep 'Scenarios' filesep scenarios{i} filesep datatypes{j,2} scenarios{i} '.csv']);
        topFeatures = readInputTableForPipeline([rootDir filesep 'data' filesep 'analysis_MicrobiomeModels' filesep 'MachineLearning_Results' filesep scenarios{i} filesep 'feature_importance' filesep 'final_feature_importance_' datatypes{j,1} '.csv']);
