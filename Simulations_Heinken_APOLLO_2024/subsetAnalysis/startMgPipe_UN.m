...
abunFilePath=[pwd filesep 'Organism_abundance_Infants_undernourished_vs_healthy.csv'];

infoFilePath = [pwd filesep 'Infants_undernourished_vs_healthy_samples.csv'];
